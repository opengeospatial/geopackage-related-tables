...
Approval Date:   TBA +
Submission Date: TBA +
External identifier of this OGC® document: TBA +
URL for this OGC® document: TBA +
Internal reference number of this OGC® document: TBA +
Version: DRAFT-TBD +
...
This draft OGC® Encoding Standard defines a GeoPackage Extension to relate additional content (such as, but not limited to, media such as photographs and documetns) to features or attributes.
