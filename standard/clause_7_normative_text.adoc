...
|`gpkgext_relations`|null|`related_tables`|{permalink}|`read-write`
|_name of actual <<user_defined_mapping_table,User Defined Mapping Table>>_|null|`related_tables`|{permalink}|`read-write`
|=======================================================================
