:Title: OGC GeoPackage Related Tables Extension (DRAFT)
:titletext: OGC GeoPackage Related Tables Extension (DRAFT)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    17-093
|Version: 0.1
...
////
There is no informative text at this time
