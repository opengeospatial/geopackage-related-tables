:Title: OGC GeoPackage Related Tables Extension
:titletext: OGC GeoPackage Related Tables Extension
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
:permalink: http://docs.opengeospatial.org/is/18-000/18-000.html
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/gpkg-rte/1.0
|Internal reference number of this OGC(R) document:    18-000
|Version: 1.0
|Category: OGC(R) Encoding Standard
|Editor:   Jeff Yutzler
|===
...
<<<
include::annex-profile.adoc[]

<<<
include::annex-sql.adoc[]
